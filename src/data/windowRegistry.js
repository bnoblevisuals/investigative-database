...
const WINDOW_REGISTRY = {
    W001: defineWindow("W001", {
        title: "ABOUT BWC/4D",
        command:COMMAND_TYPES.OPEN_ABOUT_SYSTEM,
        top: 20,
        left: 20
    }),
    ...
    W002: defineWindow("W002", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_PERSON_PROFILE,
        top: 200,
        left: 300
    }),
    ...
    W003: defineWindow("W003", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_LOCATION_PROFILE,
        top:250,
        left: 450
    }),
    W004: defineWindow("W004", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_INCIDENT_PROFILE,
        top: 300,
        left: 500
    }),
    W005: defineWindow("W005",{
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_ORGANIZATION_PROFILE,
        top: 275,
        left: 250
    }),
    W006: defineWindow("W006",{
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_RELATIONSHIP_PROFILE,
        top: 240,
        left: 400
    }),
    W007: defineWindow("W007",{
        title: "CLAIM_PROFILE",
        menu: "Records",
        command:COMMAND_TYPES.OPEN_CLAIM_PROFILE,
        top: 220,
        left: 260
    }),
    W008: defineWindow("W008",{
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_EVIDENCE_PROFILE,
        top: 220,
        left: 260
    }),
    W009: defineWindow("W009",{
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_EQUIPMENT_PROFILE,
        top: 250,
        left: 354
    }),
    W010: defineWindow("W010",{
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_VEHICLE_PROFILE,
        top: 200,
        left: 300
    }),
    W011: defineWindow("W011",{
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_VEHICLE_STATUS_PROFILE,
        top: 250,
        left: 300
    }),
    W012: defineWindow("W012", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_TIMELINE_EVENT_PROFILE,
        top: 250,
        left: 300
    }),
    W013: defineWindow("W013", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_EVENT_PARTICIPANT_PROFILE,
        top: 250,
        left: 300
    }),
    W014: defineWindow("W014", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_THREAT_ASSESSMENT_PROFILE,
        top: 250,
        left: 300
    }),
    W015: defineWindow("W015",{
        title: "SYSTEM_USER_PROFILE",
        command:COMMAND_TYPES.OPEN_SYSTEM_USER_PROFILE,
        top: 250,
        left: 300
    }),
    W016: defineWindow("W016",{
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_RECORD_AUDIT_PROFILE,
        top: 250,
        left: 300
    }),
    W017: defineWindow("W017", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_INCIDENT_PARTICIPANT_PROFILE,
        top: 250,
        left: 300
    }),
    W018: defineWindow("W018", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_CLAIM_EVIDENCE_PROFILE,
        top: 250,
        left: 300
    }),
    W019: defineWindow("W019", {
        ...
        menu: "Records",
        command:COMMAND_TYPES.OPEN_INVENTORY_ITEM_PROFILE,
        top: 250,
        left: 300
    })
